...
(function(){
  ...
  async function render(){
    ...
    try{
      const resp = await fetchJson('/safer/api/pay.php?job_id=' + encodeURIComponent(jobId));
      ...
      try{ invoiceCfg = await fetchJson('/safer/scripts/invoice.json'); }catch(e){}
      ...
      if(invoiceCfg.paystack_public_key){
        paystackBtn.addEventListener('click', async ()=>{
          try{
            ...
            const init = await fetchJson('/safer/api/pay-init.php?job_id=' + encodeURIComponent(job.id));
            ...
            const handler = PaystackPop.setup({
              ...
              callback: function(response){
                ...
                window.location = '/safer/api/pay-verify.php?job_id=' + encodeURIComponent(job.id) + '&reference=' + encodeURIComponent(response.reference);
              },
              onClose: function(){
