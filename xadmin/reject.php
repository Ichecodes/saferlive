...
if ($currentAction === 'approved') {
    redirectToCandidates('Approved candidates cannot be rejected.', 'warning');
}
...
if (!$ok) {
    redirectToCandidates('Failed to log rejection action.', 'error');
}

redirectToCandidates('Candidate rejected.', 'success');
